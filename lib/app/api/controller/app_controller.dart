...
Widget wrapWithModel<T extends AppController>({
  required T model,
...
T createModel<T extends AppController>(
...
abstract class AppController<W extends Widget> {
...
class FlutterFlowDynamicModels<T extends AppController> {
